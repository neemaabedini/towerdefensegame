 ...
 * level-scaling curve, the armor floor, the slow multiplier, and the contact
 * radii were magic numbers scattered through `buildings.ts` and `Game.ts`.
 * A port had to read TypeScript and hand-copy
